...
def normalize_serial(serial: str) -> str:
    ...
    s = str(serial).lower()  # Convert to string just in case
...
def print_report(merged_rows, conflicts):
    ...
    for r in merged_rows:
        ...
        assigned = r['assigned_user'] or ''
        status = r['status'] or ''
        found_in = r['found_in'] or ''
        print(f"{serial:<14} {device:<16} {assigned:<40} {status:<25} {found_in}")
